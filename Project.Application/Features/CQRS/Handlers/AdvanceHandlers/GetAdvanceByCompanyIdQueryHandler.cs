...
{
    public class GetAdvanceByCompanyIdQueryHandler
    {
        private readonly IUnitOfWork unitOfWork;

        public GetAdvanceByCompanyIdQueryHandler(IUnitOfWork unitOfWork)
        {
        ...
        public async Task<List<GetAdvanceWithEmployeeQueryResult>> Handle(GetAdvanceByCompanyId query)
        {
            var values = await unitOfWork.advanceRepository.GetAdvanceWithEmployeeByCompanyId(query.Id);
